...
## Project Structure
    ...
    ├── testapiautoconnecto_80584  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_80584`
...
2. Clone this repo and `cd testapiautoconnecto_80584`
